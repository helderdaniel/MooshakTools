...
set          CPU 0
set       Memory 0
set     Feedback {{Observações de &lt;b&gt;Compile Time Error&lt;/b&gt; &lt;pre&gt;src/ClientTest.java:1: error: package org.junit does not exist
import org.junit.Test;
                ^
src/ClientTest.java:7: error: package org.junit does not exist
import static org.junit.Assert.assertEquals;
                       ^
src/ClientTest.java:7: error: static import only from classes and interfaces
import static org.junit.Assert.assertEquals;
^
...
import static org.junit.Assert.assertEquals;
^
src/ClientTest.java:37: error: cannot find symbol
    @Test
     ^
  symbol:   class Test
...
src/T2timeTests.java:31: error: cannot find symbol
  ...
  symbol:   class Test
  location: class T2timeTests
src/ClientTest.java:44: error: cannot find symbol
